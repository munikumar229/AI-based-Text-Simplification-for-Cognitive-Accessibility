...
def get_texts(lang):
    if lang == "English":
        return {
            ...
            "obstacles": "Select your reading difficulties",
        ...
        return {
            ...
            "obstacles": "చదవడానికి కష్టమైన కారణాలు ఎంచుకోండి",
            "prefs": "🛠️ పఠన ప్రాధాన్యతలు",
            "text_input": "✍️ మీ పాఠ్యాన్ని ఇవ్వండి",
            "placeholder_paste": " మీ వచనం పేస్ట్ చేయండి",
